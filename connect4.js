...
["decryption_modal", "decryption"],
  ...
  ["tls_modal", "tls"],
  ["ssh_modal", "ssh"],
  ["rainbowtable_modal", "rainbowtable"],
  ["digicert_modal", "digicert"],
  ["twofactorauth_modal", "twofactorauth"],
                  ...
                  ["malware_rainbowtable_modal", "malware_rainbowtable"],
                  ["firewall_modal", "firewall"],
                     ...
                     ["pua_modal", "pua"],
                     ["ids_modal", "ids"],
                     ["sslinspection_modal", "sslinspection"],
                     ["confidentiality_modal", "confidentiality"],
                     ["integrity_modal", "integrity"],
                     ["availability_modal", "availability"]
                    ];
      ...
      console.log(idPair[0]+" " + idPair[1] + " " + modalObj);
